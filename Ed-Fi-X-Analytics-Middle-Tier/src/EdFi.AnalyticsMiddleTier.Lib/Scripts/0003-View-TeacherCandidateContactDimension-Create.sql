/****** Object:  View [analytics].[TeacherCandidateContactDimension]    Script Date: 4/23/2019 2:46:47 AM ******/
SET ANSI_NULLS ON
GO
...
AS (SELECT [TeacherCandidateElectronicMail].[TeacherCandidateIdentifier],
    ...
    FROM [tpdm].[TeacherCandidateElectronicMail]
     ...
     TeacherCandidateContact
AS (SELECT [TeacherCandidate].[TeacherCandidateIdentifier] AS [TeacherCandidateKey],
           SchoolYear =
           (
    ...
    FROM [tpdm].[TeacherCandidate] [TeacherCandidate]
        LEFT OUTER JOIN [TeacherCandidateAddress] HomeAddress
            ON [TeacherCandidate].[TeacherCandidateIdentifier] = [HomeAddress].[TeacherCandidateIdentifier]
...
SELECT [analytics].[EntitySchoolYearInstanceSetKey](
                                                       TeacherCandidateContact.TeacherCandidateKey,
                                                       TeacherCandidateContact.SchoolYear
                                                   ) TeacherCandidateSchoolYearInstanceKey,
       TeacherCandidateContact.TeacherCandidateKey,
       TeacherCandidateContact.SchoolYear,
       TeacherCandidateContact.StudentKey,
       TeacherCandidateContact.FirstName,
       TeacherCandidateContact.LastName,
       TeacherCandidateContact.HomeAddress,
       TeacherCandidateContact.PhysicalAddress,
       TeacherCandidateContact.MailingAddress,
       TeacherCandidateContact.WorkAddress,
       TeacherCandidateContact.TemporaryAddress,
       TeacherCandidateContact.HomePhoneNumber,
       TeacherCandidateContact.MobilePhoneNumber,
       TeacherCandidateContact.WorkPhoneNumber,
       TeacherCandidateContact.PrimaryEmailAddress,
       TeacherCandidateContact.PersonalEmailAddress,
       TeacherCandidateContact.WorkEmailAddress
FROM TeacherCandidateContact;
