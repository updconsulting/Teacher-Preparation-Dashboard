...
AS (SELECT tcar.TeacherCandidateIdentifier,
...
SELECT [analytics].[EntitySchoolYearInstanceSetKey](x.TeacherCandidateKey, x.Schoolyear) TeacherCandidateSchoolyearInstaceKey,
       ...
       [analytics].[EntitySchoolYearInstanceSetKey](x.TeacherCandidatePreparationProviderKey, x.Schoolyear) TeacherCandidatePreparationProviderSchoolYearInstanceKey,
